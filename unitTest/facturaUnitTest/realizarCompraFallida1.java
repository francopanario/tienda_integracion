...
public class realizarCompraFallida1 {

	@Test
	public void test() throws UsuarioException, FacturaException, ProductoException{
		...
		String cantidad = "40";
		Controlador.getInstancia().nuevaFactura(String.valueOf(n), username, password, codBarra, cantidad, null);
	}
